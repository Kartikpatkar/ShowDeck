  ...
  return `
    <div class="page-container animate-fade-in">
      ...
      <div class="grid-display gap-8" style="grid-template-columns:repeat(auto-fit, minmax(300px, 1fr));">
        ...
        <!-- Sync & Backup -->
        <div class="card p-6" style="display:flex; flex-direction:column; gap:var(--space-4); grid-column: 1 / -1;">
          <div class="flex items-center gap-2 mb-2">
            <svg class="text-accent" style="width:24px; height:24px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12h4l2-9 5 18 5-18 2 9h4"/></svg>
            <h3 class="section-title m-0">ShowDeck Sync</h3>
          </div>
          
          <div class="flex flex-col gap-3">
            <div class="flex justify-between items-center" style="background:var(--surface-2); padding:var(--space-4); border-radius:var(--radius-md);">
              <div>
            ...
            <div class="flex flex-col gap-3" id="drive-signin-actions" style="display:none;">
              <button class="btn btn-primary" style="background:#1a73e8; border:none; color:white;" id="drive-signin-btn">
      ...
      <div style="text-align:center;padding:var(--space-4) 0;">
        ...
        <div style="font-size:var(--text-xs); display:flex; justify-content:center; gap:var(--space-4);">
          <a href="./privacy.html" target="_blank" style="color:var(--text-secondary); text-decoration:underline;">Privacy Policy</a>
          <a href="./terms.html" target="_blank" style="color:var(--text-secondary); text-decoration:underline;">Terms & Conditions</a>
        </div>
      </div>
    </div>
  `;
